...
// 1. What is "this" when joe.scope() is invoked? It refers to the object
//
// 2. What is "this" when joe.scopeArrow() is invoked? It doesn't refer to object
//
// 3. Explain why "this" is different when an arrow function is used. The this keyword is bound to different values based on the context in which the function is called
//
